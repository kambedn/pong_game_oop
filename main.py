...
from score import Score, HalfLine, GameOver
import time
...
# Creating Score
score_right = Score(x_pos=30)
score_left = Score(x_pos=-30)

# Creating a GameOver object
game_over = GameOver()
